  ...
  <div>
    <div id="header" class="bg-[url('/hero-bg.jpg')] md:px-20 px-5">
      <div id="menu" class="grid grid-cols-2 py-5">
        ...
        <div id="menu-right">
          <ul
            class="grid md:grid-cols-5 text-lg font-oswald text-white uppercase text-right pt-5"
          >
      ...
      <div class="grid md:grid-cols-2 pb-20 pt-10 text-center">
        <img src="hero-burger.png" class="md:pr-10 mt-10" alt="" />
        <div>
          <h1 class="pt-5 text-8xl text-white text-centre font-lilita uppercase">
            Classic Burger
          </h1>
          <h2 class="text-6xl text-white text-center font-lilita uppercase mt-5 mb-5">
            With Onion
          </h2>
          <p class="text-white font-roboto font-light text-center pb-6">
    ...
    <div
      id="section-1"
      class="text-center bg-[url('/three-burgers')] pb-60 bg-cover bg-center"
    >
      ...
      <p
        class="text-bold font-light text-gray-500 text-center text-lg py-6 md:px-28 px-10"
      >
    ...
    <div
      id="section-2"
      class="grid md:grid-cols-3 bg-yellow-500 text-center px-20 pt-5 gap-10"
    >
      <div>
        <svg
    ...
    <div id="section-3" class="text-center">
      ...
      <div class="grid md:grid-cols-2 md:px-40 gap-5">
        <div id="left-item-column">
          <Item
            ...
            description="Chicken
          breast, chili sauce, tomatoes, pickles,
          coleslaw"
            price="11.99"
          />
          <Item
        ...
        <div id="right-item-column">
          <Item
            ...
            description="House beef
          patty, cheddar cheese, smokey bacon, onion, mustard"
            price="14.99"
          />
          <Item
            image="double-burger.jpg"
            title="Double Burger"
            description="2 beef patties,cheddar cheese,
      ...
      >
        ...
        <div
          class="md:col-span-7 bg-cover bg-center bg-[url('/burger-bg-1.jpg')] text-right pl-20 pb-10 pt-10 pr-10"
        >
          <h4>
            Crispy <br />
            Chicken
    ...
    <div id="section-4" class="md:px-20 bg-gray-100 py-20">
      ...
      <p class="text-lg text-gray-500 mt-8 px-10">
    ...
    <div id="section-5" class="grid md:grid-cols-5 bg-yellow-500 text-amber-900">
      <div class="col-span-3 md:pl-20 pl-5 pt-16 pb-16 pr-5 text-center">
        ...
        <p class="text-lg my-7">
          ...
          the convinience of ordering food online at any time and from any location.
        </p>
